...
- 纵轴：男性 → 中性 → 女性（9 级独立插帧）
- 年龄轴：婴儿 → 成人 → 老人（17 级独立插帧）
- 高清眼镜层随人物轴从深色镜框连续过渡到浅银色镜框
- 采用老虎机风格的球形握把、镀铬长杆与固定底座
...
人物、性别与年龄锚点经过 [RIFE ncnn Vulkan](https://github.com/nihui/rife-ncnn-vulkan) 扩展为 17 × 9 × 31 的独立帧网格。网页根据三个滑杆的位置直接切换单张 WebP 文件，不进行多图透明混合。
